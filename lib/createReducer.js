...
function createReducer(structure) {
  ...
  var plainDeleteInWithCleanUp = (0, _deleteInWithCleanUp2.default)(
    _plain2.default
  )
  ...
  _defineProperty(_behaviors, _actionTypes.ARRAY_INSERT, function(state, _ref) {
  ...
  _defineProperty(_behaviors, _actionTypes.CLEAR_SUBMIT_ERRORS, function(
    state
  ) {
    var result = state
  ...
  _defineProperty(_behaviors, _actionTypes.CLEAR_FIELDS, function(
    state,
    _ref15
  ) {
  ...
  _defineProperty(_behaviors, _actionTypes.START_ASYNC_VALIDATION, function(
    state,
    _ref19
  ) {
  ...
  _defineProperty(_behaviors, _actionTypes.STOP_ASYNC_VALIDATION, function(
    state,
    _ref20
  ) {
  ...
  _defineProperty(_behaviors, _actionTypes.SET_SUBMIT_SUCCEEDED, function(
    state
  ) {
    var result = state
    result = deleteIn(result, 'submitFailed')
  ...
  _defineProperty(_behaviors, _actionTypes.UPDATE_SYNC_WARNINGS, function(
    state,
    _ref27
  ) {
